...
for (Ele, EleForceD, EleForceDL, EleForceDLE) in zip(Elements, ElemnsForceD, ElemnsForceDL, ElemnsForceDLE):
    ...
    if Ele.EleTag in ListEleTagBeams:
        ...
        VI3 = 0.9 * VID - 1.0 * VIE
        VI4 = abs(-(Mpr_P1 + Mpr_N2) / Ele.LEle + ((1.2 + 0.2*Sds)*WDL + 1.0*WLL)/FN * Ele.LEle / 2.)
        VI5 = (Mpr_N1 + Mpr_P2) / Ele.LEle + ((1.2 + 0.2*Sds)*WDL + 1.0*WLL)/FN * Ele.LEle / 2.
        ...
        VE3 = 0.9 * VED + 1.0 * VEE
        VE4 = (Mpr_P1 + Mpr_N2) / Ele.LEle + ((1.2 + 0.2*Sds)*WDL + 1.0*WLL)/FN * Ele.LEle / 2.
        VE5 = abs(-(Mpr_N1 + Mpr_P2) / Ele.LEle + ((1.2 + 0.2*Sds)*WDL + 1.0*WLL)/FN * Ele.LEle / 2.)
