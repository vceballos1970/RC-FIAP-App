...
Test = np.loadtxt('CSS/' + InputCSSFile + '_Test_Run_Earthquake.txt', dtype=str, delimiter=',', skiprows=0)
...
ax1.legend(loc="lower right", title="Hazard levels", title_fontsize='small', fancybox=True, shadow=True, ncol=1,
           fontsize=6)
ax2.legend(loc="lower right", title="Hazard levels", title_fontsize='small', fancybox=True, shadow=True, ncol=1,
           fontsize=6)
ax3.legend(loc="lower right", title="Hazard levels", title_fontsize='small', fancybox=True, shadow=True, ncol=1,
           fontsize=6)
